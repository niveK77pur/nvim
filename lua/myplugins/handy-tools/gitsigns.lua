return { 'lewis6991/gitsigns.nvim', disable = false,
    config = function()
        require('gitsigns').setup {
            on_attach = function(bufnr)
                ...
                map('n', '<leader>ghb', function() gs.blame_line { full = true } end, { desc = 'Gitsigns: Blame line' })
                ...
                map('n', '<leader>gtd', gs.toggle_deleted, { desc = 'Gitsigns: toggle showing deleted lines' })
